...
var project7 = new projectX('7: Rock Paper Scissors', 'on-line version of the popular rock-paper-scissors game. In this version you will be able to play the game or to just "watch" other people play. Or, if a spot is available, you can play the game against someone else.', 'RPS-Multiplayer', 'inProgress');
